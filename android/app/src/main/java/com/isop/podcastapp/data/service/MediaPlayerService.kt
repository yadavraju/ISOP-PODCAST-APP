package com.isop.podcastapp.data.service
...
import com.isop.podcastapp.data.exoplayer.*
import com.isop.podcastapp.ui.MainActivity
...
class MediaPlayerService : MediaBrowserServiceCompat() {
    ...
    override fun onCreate() {
        ...
        val activityPendingIntent = Intent(this, MainActivity::class.java)
            .apply {
                action = Constant.ACTION_PODCAST_NOTIFICATION_CLICK
            }
            .let {
